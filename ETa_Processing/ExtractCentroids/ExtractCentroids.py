...
# Syntax:
# python ExtractCentroids.py [FilePath]


#Typical commands...
# python ExtractCentroids.py "../../../../../PowWowData/landiq/ETaCrop2014/ETaCrop2014.shp"
...
if(FileType == "SHP"):
    ...
    SHP = True
PathName = sys.argv[1]
assert (SHP != False), "Invalid file format"
...
#Added this in to prevent accidental overwrites
...
for Feature in Layer:
    ...
    CentroidGeoJson = Geometry.Centroid().ExportToJson()
    ...
    cur.execute("""INSERT INTO huron_delano_centers ( id, crop, acres, centroid ) VALUES (%s, %s, %s, %s) """, (IndexNumber, Crop, Acres, json.dumps(CentroidGeoJson)))
